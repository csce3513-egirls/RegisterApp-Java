...
public class EmployeeCreateCommand implements ResultCommandInterface<Employee> {
	...
	public Employee execute() {
		...
		final EmployeeEntity createdProductEntity = this.createEmployeeEntity();

		// Synchronize information generated by the database upon INSERT.
		this.apiEmployee.setId(createdProductEntity.getId()); 
		this.apiEmployee.setCreatedOn(createdProductEntity.getCreatedOn());
